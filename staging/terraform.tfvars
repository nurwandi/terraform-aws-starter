...
node_groups = {
  general = {
    desired_size   = 2 # ADJUST
    min_size       = 1 # ADJUST
    max_size       = 5 # ADJUST
    instance_types = ["t3.medium"] # ADJUST
...
alb_enable_access_logs = false # ADJUST: Enable for production
alb_access_logs_bucket = "" # ADJUST: S3 bucket name for access logs
alb_access_logs_prefix = "alb-logs" # ADJUST

# WAF (optional)
alb_enable_waf      = false # ADJUST
alb_waf_web_acl_arn = "" # ADJUST: WAF Web ACL ARN

# HTTP Listener
alb_enable_http_listener   = true
alb_http_redirect_to_https = false # ADJUST: true to redirect HTTP to HTTPS

# HTTPS Listener (requires ACM certificate)
alb_enable_https_listener = false # ADJUST: Enable if you have SSL certificate
...
# Storage
ec2_root_volume_size      = 20 # ADJUST: GB
